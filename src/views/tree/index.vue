<template>
  <div class="theme1 site-tree">
    <div class="search">
      ...
      <el-select @change="selected" size="small" v-model="value" clearable filterable remote reserve-keyword placeholder="请输入关键词" :remote-method="remoteMethod" :loading="loading">
